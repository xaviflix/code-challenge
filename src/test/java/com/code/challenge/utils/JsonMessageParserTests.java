...
import static com.code.challenge.utils.JsonMessageParser.parseJsonMessage;
...
public class JsonMessageParserTests {
    ...
    void when_parsing_event_json_returns_list_of_events() {
        String correctEventJson = "{" +
                "\"sessionId\": \"asfla-asdf-asdfa\", " +
                "\"events\": [" +
                "{\"eventAt\": 1688057249, \"eventType\": \"drivenDistance\", \"numericEventValue\": 123.347}," +
                "{\"eventAt\": 1688058249, \"eventType\": \"consumedFuel\", \"numericEventValue\": 2}" +
                "]" +
                "}";
        ...
        assertEquals(new BigDecimal("123.347"), ((Event)result.get(0)).getEventValue());
        ...
        assertEquals(new BigDecimal("2"), ((Event)result.get(1)).getEventValue());
    }
}
